package com.fsbay.edu.commons.digester;
import java.io.File;
...
public class TestDigester1 {
       ...
       public static void main(String[] args) {
              ...
              try {
                     List<Parent> parents=(ArrayList<Parent>) digester.parse(new File("D:/my_doc/github/common/apache-common/src/main/resources/NewFile.xml"));
                     System.out.println(parents.get(0).getChilds().get(0).getName());
              } catch (Exception e) {
                     e.printStackTrace();
              }
       }
